 ...
 * unreachable from here. The service-role key the caller's client was built
 * with is what that function authenticates against, so no new credential
 * plumbing is introduced. Nothing here logs a token, code, or Apple response.
 */
