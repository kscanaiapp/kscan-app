# QA Report — Google Glasses Structure Cleanup
...
Move the Google Glasses / Android XR work out of the main K Scan mobile app repo working tree and into its own sibling workspace.
...
## New workspace Git repo initialized
