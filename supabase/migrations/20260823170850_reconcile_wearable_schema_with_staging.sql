...
-- source_original_filename: kscan-glasses-webapp: supabase/migrations/20260823170850_reconcile_wearable_schema_with_staging.sql (exact filename match)
-- source_commit:            fea5712 (kscan-glasses-webapp)
-- ledger_version:           20260823170850
-- Source commit content verified byte-equivalent (comment/formatting differences only) to the ledger-executed SQL.
--
