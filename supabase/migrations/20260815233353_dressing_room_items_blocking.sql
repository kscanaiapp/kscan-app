...
-- Original authored file: supabase/migrations/20260815140000_dressing_room_items_blocking.sql
-- Original source commit: 64104bf
-- Applied to staging (yzqjvdfgefveprobvvyw) as ledger version: 20260815233353
-- Authored filename timestamp (20260815140000) differs from the Management-API-assigned ledger version; never renamed in source control.
--
