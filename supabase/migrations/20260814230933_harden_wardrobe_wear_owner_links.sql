...
-- Original source commit: 02a51f2
-- Applied to staging (yzqjvdfgefveprobvvyw) as ledger version: 20260814230933
-- 02a51f2 is a same-day fix of an earlier draft (2c02541) that contained two destructive DROP CONSTRAINT statements never actually executed on staging; 02a51f2's content matches the ledger exactly, 2c02541 does not.
--
