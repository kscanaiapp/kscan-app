...
-- Original authored file: supabase/migrations/20260808103028_privacy_request_rate_limits.sql
-- Original source commit: 25e970d
-- Applied to staging (yzqjvdfgefveprobvvyw) as ledger version: 20260808121216
-- Renamed to the ledger-assigned version by 25e970d; Management API assigns its own migration version at apply time, independent of the authored filename (see backfill_legacy_pending_deletion_requests below for the same pattern).
--
