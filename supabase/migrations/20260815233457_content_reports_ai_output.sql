...
-- Original authored file: supabase/migrations/20260815120000_content_reports_ai_output.sql
-- Original source commit: a536f23
-- Applied to staging (yzqjvdfgefveprobvvyw) as ledger version: 20260815233457
-- Authored filename timestamp (20260815120000) differs from the Management-API-assigned ledger version; never renamed in source control.
--
