...
-- source_original_filename: kscan-glasses-webapp: supabase/migrations/20260819000001_add_wearable_pairing_session.sql (embedded original name in ledger: 20260815015710_wearable_pairings_sessions)
-- source_commit:            9311442 (kscan-glasses-webapp)
-- ledger_version:           20260819125404
-- kscan-glasses-webapp's own committed file diverges from this exact content (no length CHECKs, has defaults); this canonical copy is the ledger-executed version, later hardened by 20260823170850 below.
--
