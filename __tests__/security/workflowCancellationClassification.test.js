...
// CASE 17 / CASE 18 guards are deliberately NOT ported here. Upstream (PR
// #238, on staging/production-parity) they assert against
// security/scripts/lib/certification-authority.js and
// security/scripts/lib/environment-authority.js — two modules from that
// branch's staging security baseline that do not exist on this integration
// line. Requiring them would mean importing that baseline wholesale, which is
// out of scope for this convergence. The quarantine-policy and
// production-ref refusals they cover remain enforced on
// staging/production-parity, where those modules actually live.
