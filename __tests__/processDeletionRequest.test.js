...
test('the edge-function registry mirror also covers privacy_request_rate_limits', () => {
  const mirror = fs.readFileSync(
    path.join(__dirname, '..', 'supabase', 'functions', '_shared', 'deletion', 'userDataResources.ts'),
    'utf8',
  );
  assert.match(
    mirror,
