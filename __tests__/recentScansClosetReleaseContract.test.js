...
function renderLibrary({
  ...
  const modules = {
    ...
    // iPad responsive layout is a pure function of window width. Pinned to the
    // compact (phone) class here so the assertions below are about Recent
    // Scans / Closet identity, not about which size class is active.
