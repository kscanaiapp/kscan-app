...
function load() {
  ...
  const shim = (spec) => {
    ...
    // The Android line normalizes purchase options in ./purchaseOptions, the
    // iOS line in ./dressingRoomCommerce. Neither is exercised here — commerce
    // is stubbed out so this stays a thumbnail test.
