...
test('errors: a configuration failure is NOT reported as a bad password', () => {
...
test('errors: the four non-credential categories are mutually distinguishable', () => {
  const messages = new Set([
    mapAuthError('Invalid login credentials', 'sign-in'),
    mapAuthError('Email not confirmed', 'sign-in'),
    mapAuthError('Supabase configuration error [missing_url]: x', 'sign-in'),
