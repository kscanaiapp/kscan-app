...
test('mapAuthError: unknown error maps to safe mode-specific copy (never raw)', () => {
  // Raw backend messages must not surface to users. Unknown errors fall back to
  // safe, mode-specific copy.
