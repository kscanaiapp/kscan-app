...
export const WEATHER_COPY = {
  ...
  promptBody:
    'K Scan AI can use your approximate location to tailor Elise suggestions to your local weather. Location is optional, used only while you are using the app, and raw coordinates are not stored.',
  promptUse: 'Use approximate location',
