...
// Signals that could not be implemented in v0.3 due to missing source data.
export const STYLE_MEMORY_MISSING_SIGNALS = [
  ...
  'dressing_room_negative_feedback — no negative reaction type; all reactions are positive (like/love/favorite/looking)',
] as const;
