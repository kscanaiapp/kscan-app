 ...
 *      `SCANNER_MAX_ATTEMPTS = 2` per logical call, so a 56-call plan can make up
 *      to 112 provider attempts while the ledger still reads 56. A ceiling
 *      enforced against planned calls does not bound provider attempts at all.
