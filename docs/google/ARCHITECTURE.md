...
This document provides a high-level architecture summary for the Google Glasses workspace.

For the full system context, see the original [docs/ARCHITECTURE.md](../ARCHITECTURE.md).
