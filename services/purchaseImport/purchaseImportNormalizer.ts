...
/**
 * ISO 4217 codes K Scan recognises as circulating currencies. A three-letter
 * string is not a currency just because it has the right shape, and
 * `Intl.NumberFormat` accepts ANY well-formed code, so it cannot be the check.
 * Special drawing rights, test codes and withdrawn codes are excluded.
 */
