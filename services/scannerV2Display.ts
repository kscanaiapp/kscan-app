 ...
 *
 * KSB29-037: this and `normalizePatternLabel` below existed in the approved
 * Build 28 line and were lost across the Build 28 -> Build 29 fork, taking the
 * whole Pattern contract with them. Restored here as the single place any
 * surface has to know about placeholder pattern values.
 */
