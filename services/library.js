  ...
  try {
    ...
    const scan = {
      ...
      attributes: {
        ...
        texture:           analysis.metadata?.texture     ?? null,
        occasion:          analysis.metadata?.occasion    ?? null,
        style_tags:        Array.isArray(analysis.metadata?.styleTags) ? analysis.metadata.styleTags : [],
        confidence_score:  typeof analysis.metadata?.confidence === 'number' ? analysis.metadata.confidence : null,
      },
