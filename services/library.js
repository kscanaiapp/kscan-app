  ...
  try {
    ...
    const scan = {
      ...
      attributes: {
        ...
        // Pattern (KSB29-037 / BUG-11). The mapper has always produced this and
        // the legacy attribute block silently dropped it, so a reopened scan
        // could never show a pattern and the cloud consumers that read
        // metadata.pattern always read null. Absent stays null — never invented.
