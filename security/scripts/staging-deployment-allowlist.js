...
const STAGING_DEPLOYMENT_ALLOWLIST = [
  ...
  'staging-health',
  // Account-deletion worker source remains governed so privacy, authorization,
  // and lifecycle fixes can reach staging for owner-authorized manual testing.
  // Automatic purge/scheduler activation is explicitly deferred for Build 29.
  // Destructive behaviour stays gated behind two independent app_config switches
